...
export const AirbnbReviews = ({
  ...
  return <section className="bg-stone-50 py-[15px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Green CTA Container */}
        <div className="border-4 border-emerald-700 bg-emerald-50 rounded-2xl p-8 shadow-lg">
          {/* Header */}
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 max-w-6xl mx-auto py-[15px] px-[15px]">
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <Button onClick={handleAirbnbClick} className="text-white px-6 py-2 rounded-lg text-2xl bg-[#ff5a5f] hover:bg-[#e04e52]">
                Review us on Airbnb
              </Button>
            </div>

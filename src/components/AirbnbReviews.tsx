  ...
  return <section className="bg-stone-50 py-[15px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-4 border-emerald-700 bg-emerald-50 rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 mb-8 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              return <div key={review.id} className="bg-gray-50 rounded-xl p-4 sm:p-6 border border-gray-200">
                    {/* Reviewer Info */}
                    ...
                    <div className="text-gray-700 leading-relaxed text-sm sm:text-base">
                      ...
                      {showReadMore && <button onClick={() => toggleReadMore(review.id)} className="text-gray-500 hover:text-gray-700 mt-2 text-xs sm:text-sm font-medium">
          ...
          <div className="text-center">
            {setIsInquiryOpen && <Button size="lg" onClick={() => setIsInquiryOpen(true)} className="w-full sm:w-auto bg-emerald-900 hover:bg-emerald-800 text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg">Book your stay today</Button>}
          </div>
        </div>
      </div>
    </section>;

...
export const H1: React.FC<TypographyProps> = ({ children, className = '', id }) => (
  <h1 id={id} className={`${getTypographyClasses('h1')} ${className}`}>
    {children}
  </h1>
);

export const H2: React.FC<TypographyProps> = ({ children, className = '', id }) => (
  <h2 id={id} className={`${getTypographyClasses('h2')} ${className}`}>
    {children}
  </h2>
);

export const H3: React.FC<TypographyProps> = ({ children, className = '', id }) => (
  <h3 id={id} className={`${getTypographyClasses('h3')} ${className}`}>
    {children}
  </h3>
);

export const H4: React.FC<TypographyProps> = ({ children, className = '', id }) => (
...
export const BodyBase: React.FC<TypographyProps> = ({ children, className = '' }) => (

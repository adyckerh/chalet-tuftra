...
const Index = () => {
  ...
  return <div className="min-h-screen bg-stone-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4 bg-transparent">
            <div className="flex items-center space-x-4 flex-1">
              <button onClick={scrollToTop} className="flex items-center space-x-4 hover:opacity-80 transition-opacity">
            ...
            <div className="hidden lg:flex items-center space-x-6 ml-8">
              ...
              <LanguageSelector />
              <Button onClick={() => setIsInquiryOpen(true)} className="bg-emerald-900 hover:bg-emerald-800 text-white whitespace-nowrap" size="sm">
                {t('make_inquiry')}
              </Button>
            </div>
          </div>
      ...
      {/* Hero Section - Full viewport behind navigation */}
